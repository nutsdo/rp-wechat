...
class CreateMenusTable extends Migration {
    ...
    public function initializeMenus()
    {
        ...
        $menus = array(
            ...
            array('name'=>'setting_wechat','route_name'=>'admin.wechat','icon'=>'fa-wechat','fid'=>'0'),
            ...
            array('name'=>'setting_node','route_name'=>'admin.node','icon'=>'','fid'=>'3'),
            ...
            //wechat
            array('name'=>'setting_wechat_ucenter','route_name'=>'admin.wechat.ucenter','icon'=>'fa-wechat','fid'=>'7'),
        );
