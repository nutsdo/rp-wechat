    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                {!! Form::open(['route'=>'admin.event.awardstore','role'=>'form','class'=>'form-horizontal',]) !!}
                    ...
                    <div class="form-group @if($errors->first('totals')) has-error @endif">
                        ...
                        <div class="col-sm-11">
                            <input type="text" name="totals" class="form-control" id="totals" placeholder="@if($errors->first('totals')) {{$errors->first('totals')}} @else 数量 @endif">
                        </div>
                    </div>
