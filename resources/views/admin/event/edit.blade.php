    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                {!! Form::open(['route'=>['admin.event.update',$event->id],'role'=>'form','class'=>'form-horizontal',]) !!}

                    <div class="form-group @if($errors->first('title')) has-error @endif">
                        <label class="col-sm-1 control-label" for="title">标题</label>

                        <div class="col-sm-11">
                            <input type="text" name="title" value="{{$event->title}}" class="form-control" id="title" placeholder="@if($errors->first('title')) {{$errors->first('title')}} @else 标题 @endif">
                        </div>
                    </div>
                    ...
                    <div class="form-group @if($errors->first('planner')) has-error @endif">
                        ...
                        <div class="col-sm-11">
                            <input type="text" name="planner" value="{{$event->planner}}" class="form-control" id="planner" placeholder="@if($errors->first('planner')) {{$errors->first('planner')}} @else 策划人 @endif">
                        </div>
                    </div>
                    ...
                    <div class="form-group @if($errors->first('description')) has-error @endif">
                        ...
                        <div class="col-sm-11">
                            <input type="text" name="description" value="{{$event->description}}" class="form-control" id="description" placeholder="@if($errors->first('description')) {{$errors->first('description')}} @else 描述 @endif">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-11">
                            ...
                            <input type="text" name="event_time" value="{{date('d/m/Y h:i A',$event->start_at)}}-{{date('d/m/Y h:i A',$event->end_at)}}" id="event_time" class="form-control daterange" data-time-picker="true" data-time-picker-increment="5" data-format="MM/DD/YYYY h:mm A" />
