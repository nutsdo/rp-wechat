	...
	<nav class="navbar horizontal-menu navbar-fixed-top"><!-- set fixed position by adding class "navbar-fixed-top" -->
		...
		<div class="navbar-inner">
			...
			<div class="navbar-brand">
				...
				{!! Html::image('style/assets/images/logo-white-bg@2x.png',null,['width'=>'80','class'=>'hidden-xs']) !!}
                {!! Html::image('style/assets/images/logo@2x.png',null,['width'=>'80','class'=>'visible-xs']) !!}
				</a>
				<a href="#" data-toggle="settings-pane" data-animate="true">
			...
			<ul class="navbar-nav">
				...
				<li class="opened active">
					<a href="{{route('ucenter.wechat')}}">
						<i class="linecons-desktop"></i>
						<span class="title">微信功能</span>
					</a>
				</li>
			</ul>
			...
			<ul class="nav nav-userinfo navbar-right">
				...
				<li class="dropdown user-profile">
					<a href="#" data-toggle="dropdown">
					    {!! Html::image('style/assets/images/user-1.png',null,['width'=>'28','class'=>'img-circle img-inline userpic-32']) !!}
						<span>
							Arlind Nushi
