     ...
     <div class="col-sm-9 mailbox-right">
         ...
         <div class="panel panel-default">
             ...
             <div class="panel-body">
                 ...
                 {!! Form::open(['route'=>['ucenter.wechat.update',$wechat->id],'role'=>'form','class'=>'form-horizontal','method'=>'PATCH']) !!}

                    {!! Form::hidden('id',$wechat->id) !!}
                     ...
                     <div class="form-group @if($errors->first('original_id')) has-error @endif">
                         ...
                         <div class="col-sm-10">
                             <input type="text" name="original_id" class="form-control" id="original_id" value="{{$wechat->original_id}}" placeholder="@if($errors->first('original_id')) {{$errors->first('original_id')}} @else 公众号原始ID @endif">
                         </div>
                     </div>
                     ...
                     <div class="form-group @if($errors->first('avatar')) has-error @endif">
                         ...
                         <div class="col-sm-10">
                             <input type="text" name="avatar" class="form-control"  id="avatar" value="{{$wechat->avatar}}" placeholder="@if($errors->first('avatar')) {{$errors->first('photo')}} @else 头像地址 @endif">
                         </div>
                     ...
                     <div class="form-group @if($errors->first('avatar')) has-error @endif">
                         ...
                         <div class="col-sm-3">
                             ...
                             <div class="form-block">
                                 <label>
                                     <input type="radio" name="wechat_type" value="1" @if($wechat->wechat_type==1) checked @endif class="cbr cbr-secondary">
                                     订阅号
                                 </label>
                             </div>
                         ...
                         <div class="col-sm-3">
                             ...
                             <div class="form-block">
                                 <label>
                                     <input type="radio" name="wechat_type" value="2" @if($wechat->wechat_type==2) checked @endif class="cbr cbr-secondary">
                                     服务号
                                 </label>
                             </div>
                     ...
                     <div class="form-group @if($errors->first('encoding_aes_key')) has-error @endif">
                         ...
                         <div class="col-sm-10">
                             <input type="text" name="encoding_aes_key" class="form-control" id="encoding_aes_key" value="{{$wechat->encoding_aes_key}}" placeholder="@if($errors->first('encoding_aes_key')) {{$errors->first('encoding_aes_key')}} @else EncodingAESKey @endif">
                         </div>
                     </div>
